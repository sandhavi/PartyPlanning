...
<body>
  ...
  <div class="about-us">
    <div class="div">
      ...
      <div class="div-2">
        ...
        <div class="menu">
          <div class="menu-2">
            ...
            <div class="pages">
              <div class="pages-2">
                <div class="text-wrapper-6"><a href="../Pricing/index.php" style="color:aliceblue; font-size:large;  text-decoration: none;">Pricing</a>
                </div>
              </div>
              <img class="line" src="img/line-2.svg" />
            </div>
            <div class="project">
              <div class="text-wrapper-5"><a href="../customer/dashboard.php" style="color:aliceblue; font-size:large;  text-decoration: none;">My Projects</a></div>
                ...
                <div class="address">
                  <div class="email">
                    <a href="mailto:contact@hvcargologistics.com" target="_blank" rel="noopener noreferrer">
                      <div class="text-wrapper-9">Email<br />contact@partyprocom</div>
                    </a>
                    <div class="icon">
      ...
      <div class="overlap-5">
        <div class="heading">
          <div class="text-wrapper-18">What do we do?</div>
        </div>
