                      ...
                      <div class="icon-6">
                        <div class="div-3">
                          <div class="div-3">
                            ...
                            <img
                              class="star-3"
                              src="img/star-13-3.svg"
                              alt="new"
                            />
                            <img
                              class="polygon-3"
                              src="img/polygon-1-3.svg"
                              alt="new"
                            />
                          </div>
                ...
                <div class="content-5">
                  <div class="name">
                    <div class="overlap-group-8">
                      <div class="text-wrapper-18">Email here*</div>
                    </div>
                  </div>
                  <button class="button" >
                    <button class="button-2">
                      <div class="text-wrapper-19">Send Now</div>
                    </button>
