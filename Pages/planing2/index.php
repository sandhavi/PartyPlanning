      ...
      <div class="overlap-3">
        <div class="flight-search">
          ...
          <div class="text-input-2">
            <div class="base-text-input">
              <img class="calendar-date" src="img/32-calendar-with-dates-2.svg" alt="new" />
          ...
          <button class="button-3">
            <div class="label-3">Search</div>
          </button>
        </div>
        <div class="base-pill-chit">
          <div class="label-4">Times</div>
          <img class="element-chevron-down" src="img/18-chevron-down.svg" alt="new" />
        </div>
        <div class="base-text">
          <div class="text-input-4">
            <div class="base-text-input-3">
              <img class="calendar-date" src="img/32-person-solid-1.svg" alt="new" />
            ...
            <div class="popover-increment">
              <div class="row">
                ...
                <div class="incrementer">
                  <div class="increment">
                    <img class="element-plus" src="img/32-plus-5.svg" alt="new" />
                  </div>
                  <div class="text-wrapper-23">1</div>
                  <div class="increment">
                    <img class="element-plus" src="img/32-plus-10.svg" alt="new" />
                  </div>
                </div>
              </div>
              <div class="row">
        ...
        <div class="base-date-picker">
          ...
          <div class="calendar-section">
            <img class="element-chevron-left" src="img/32-chevron-left.svg" alt="new" />
            <div class="month">
              <div class="month-2">
            ...
            <img class="element-chevron-right" src="img/32-chevron-right.svg" alt="new" />
          </div>
        </div>
      </div>
    </div>
