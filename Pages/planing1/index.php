      ...
      <div class="div">
        ...
        <div class="overlap">
          <div class="overlap-group">
            <img class="img" src="img/schedule-1.png" alt="new" />
          </div>
          ...
          <div class="flight-search">
            ...
            <div class="text-input-2">
              <div class="base-text-input">
                <img
                  class="img-3"
                  src="img/32-calendar-with-dates-1.svg"
                  alt="new"
                />
            ...
            <div class="text-input-3">
              <div class="base-text-input">
                <img class="img-3" src="img/32-person-solid-1.svg" alt="new" />
