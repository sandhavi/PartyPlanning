      ...
      <div class="div">
                ...
                /> 
                  ...
                  <button class="button">
                    <button class="div-wrapper">
                      <input type="submit" class="text-wrapper-3" value="Send Now">
                    </button>
              ...
              <div class="content-3">
                ...
                <div class="address">
                  ...
                  <div class="call">
                    ...
                    <div class="icon">
                      <img class="vector-2" src="img/vector-4.svg" alt="new" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="overlap-2">
          <div class="why-choose-us">
            <img class="pattern-5" src="img/pattern.svg" alt="new" />
            <img
              class="unsplash-MD"
              src="img/unsplash-md-ha01bk7c.png"
              alt="new"
            />
          </div>
          <div class="project">
            <img class="background-2" src="img/background-3.svg" alt="new" />
            <div class="content-4">
          ...
          <button class="button-2">
            <div class="text-wrapper-9">Create a new project</div>
          </button>
          <div class="group">
            <div class="services">
              <div class="heading">
              ...
              <div class="group-2">
                <div class="element">
                  <div class="text-2">
                    ...
                    <img class="line-2" src="img/line-1.svg" alt="new" />
                  </div>
                </div>
                <div class="icon-wrapper">
                  <div class="line-wrapper">
                    <img class="line-3" src="img/line-1.svg" alt="new" />
                  </div>
                </div>
                <div class="text-4">
              ...
              <img
                class="icon-park-solid-time"
                src="img/icon-park-solid-time.png"
                alt="new"
              />
            </div>
